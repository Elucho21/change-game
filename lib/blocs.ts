...
export const BLOCS: Bloc[] = [
  {
    ...
    color: '#4f7cff',
    founded: 1949,
    members: ['USA', 'Canada', 'UK', 'France', 'Germany', 'Spain', 'Italy', 'Poland', 'Netherlands', 'Belgium', 'Norway', 'Sweden', 'Portugal', 'Greece', 'Czechia', 'Hungary', 'Romania', 'Turkey'],
    candidates: [],
  ...
  },
  {
    ...
    color: '#f0c419',
    founded: 1993,
    members: ['France', 'Germany', 'Spain', 'Italy', 'Poland', 'Netherlands', 'Belgium', 'Sweden', 'Portugal', 'Greece', 'Czechia', 'Hungary', 'Romania', 'Ireland'],
    candidates: [],
    rivals: [],
    cohesion: 78,
    description:
  ...
  },
  {
    ...
    color: '#e0603a',
    founded: 2009,
    members: ['Brazil', 'Russia', 'China', 'India', 'SouthAfrica', 'Iran', 'Egypt', 'Ethiopia', 'UAE', 'Indonesia'],
    candidates: ['Argentina', 'Venezuela', 'Bolivia', 'SaudiArabia'],
    rivals: ['USA'],
    cohesion: 48,
    description:
  ...
  },
  {
    ...
    members: [
      ...
      'Cuba', 'Panama', 'CostaRica', 'DominicanRepublic', 'Guatemala', 'Honduras',
  ...
  },
  {
    ...
    color: '#00c2d1',
    founded: 1953,
    members: ['USA', 'Japan', 'SouthKorea', 'Australia', 'Philippines'],
    candidates: ['India', 'NewZealand'],
  ...
  },
  {
    ...
    color: '#8d6e63',
    founded: 2016,
    members: ['Russia', 'Venezuela', 'SaudiArabia', 'Iran', 'Iraq', 'UAE', 'Nigeria', 'Angola', 'Algeria'],
